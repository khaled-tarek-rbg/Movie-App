...
upBtn.addEventListener('click' , ()=>{
 ...
 let filmUrl = document.querySelector('#filmUrl') //iframe
// buttons values  are ids
 let serverButtons = Array.from(document.querySelectorAll('.server-watshes button'))
        ...
        serverButtons.map((serverButton) => {
            ...
            serverButton.addEventListener('click', () => {
                    ...
                    filmUrl.src = serverButton.value
