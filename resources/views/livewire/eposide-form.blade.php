<form action="{{ route('eposide.store') }}" method="POST">
    ...
    <div class="row m-0 w-100 ">
        ...
        <div class="col-lg-3 ">
            ...
            <select wire:model="selectedSerie" required name="series" class="form-control">
        ...
        <div class="col-lg-3 pe-0">
            ...
            <input type="text" name="eposide_rate" class="form-control" required />
        </div>
