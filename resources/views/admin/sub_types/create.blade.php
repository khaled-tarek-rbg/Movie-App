...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="admin-dashboard-content   rounded">
            <form class="repeater" action="{{ route('subtypes.store') }}" method="POST">
                @csrf
                @if ($errors->any())
                ...
                <div data-repeater-list="subtypes_group">
                ...
                <button type="submit" class="btn btn-primary w-100 mt-1">Add Type</button>
