        ...
        <div class="admin-dashboard-content  rounded">
            ...
            <div class="row  justify-content-end mb-4 ">
                <div class="col-lg-3  justify-content-end d-flex">
                    <a class="btn btn-primary" href="{{ route('eposides.servers.create.animes') }}">
                        Add Watch Server
                    </a>
                </div>
                <div class="col-lg-3">
                    <a class="btn btn-primary" href="{{ route('eposides.downloadservers.create.animes') }}">
                        Add Download Server
                    </a>
                </div>
