                    ...
                    <tbody>
                        @foreach ($movies as $movie)
                            <tr>
                                ...
                                <td><a class="btn btn-link " href="{{ route('movies.edit', ['id' => $movie->id]) }}"><i
                                            class="fas fa-edit"></i></a>
                                </td>
                                <td><a class="btn btn-link "
                                        href="{{ route('movies.admin.show', ['id' => $movie->id]) }}"><i
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                                <form action="{{ route('movies.delete', ['id' => $movie->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
