...
@section('content')
    ...
    <div class="col-lg-12">
        <div class="admin-dashboard-content   rounded">
            <form class="repeater" action="{{ route('server.download.store') }}" method="POST">
                @csrf
                @if ($errors->any())
                ...
                <select name="movie" class="form-control mb-3">
                    <option value="" selected disabled>choose the movie</option>
