...
@section('content')
    <div class="col-lg-12">
        <div class="admin-dashboard-content   rounded">
            <form class="repeater" action="{{ route('channels.servers.admin.store') }}" method="POST">
                @csrf
                @if ($errors->any())
                ...
                <select name="channels" id="" class="form-control mb-2">
                    <option value="" disabled selected>Choose The Channel</option>
                ...
                <div data-repeater-list="servers">
                ...
                <button type="submit" class="btn btn-primary w-100 mt-1">Add Category</button>
