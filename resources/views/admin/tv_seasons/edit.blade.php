...
@section('content')
    <div class="col-lg-12">
        <div class="admin-dashboard-content  rounded">
            ...
            <form action="{{ route('tvs.admin.seasons.update', ['id' => $season->id]) }}" method="POST"
                ...
                <label class="text-white  mt-2" for="">Tv</label>
                <select class="form-control" name="tvs" id="">

                    <option value="{{ $season->tv->id }}">{{ $season->tv->getTranslation('name', 'en') }}</option>
                    @foreach ($tvs as $item)
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <select required name="season_production_year" id="year_production" class="form-control mt-2">
                            <option selected value="{{ $season->season_production_year }}">
                                {{ $season->season_production_year }}</option>
                        </select>
