                ...
                @else
                    ...
                    <tbody>
                        <tr>
                            ...
                            @if ($eposide->tv->getTranslation('name', 'en') == true)
                                <td class="text-white">{{ $eposide->tv->getTranslation('name', 'en') }}</td>
                            @else
                                <td class="text-white">{{ $eposide->tv->getTranslation('name', 'ar') }}</td>
                            @endif
                            ...
                            <td>
                                @foreach ($eposide->downloadservers as $item)
                                    <a class="d-block" href="{{ route('tv.watch.edit', ['id' => $item->id]) }}">
                                            ...
                                            <div class="modal-content ">
                                                <div class="modal-body  ">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('tv.watch.delete', ['id' => $item->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
