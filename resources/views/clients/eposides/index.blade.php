...
@section('content')
    <div class="col-lg-6 mx-auto center">
                    ...
                    <div class="col-lg-5 custom-serie-w p-0 mx-2 position-relative" style="height: 400px">
                        ...
                        <div class="box-content position-absolute">
                            <p>
                                ...
                                @if ($item->serie->getTranslation('name', 'ar') == true)
                                    {{ $item->serie->getTranslation('name', 'ar') }}
                                @else
        ...
        <div class="movie-categories my-5">
            <ul class="d-flex p-3">
                <li style="background-color: #6375FF;"><a href="{{ route('client.series') }}">اخر الحلقات</a></li>
                <li><a href="{{ route('series.new') }}">احدث المسلسلات</a></li>
                <li><a href="{{ route('series.old') }}">مسلسلات قديمة</a></li>
            ...
            @foreach ($paginatedEposides as $item)
                <div class="col-lg-4 similar-movie-col position-relative  mx-2  movie-container">
                    ...
                    <div class="movie-caption d-flex flex-column">
                        <p>مشاهده مسلسل {{ $item->serie->getTranslation('name', 'en') }} موسم رقم
