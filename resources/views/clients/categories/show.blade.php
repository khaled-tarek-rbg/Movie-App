...
@section('content')
    <div class="col-lg-6 mx-auto center">
        ...
        <h5 style="color: #C3CBFF ; " class="m-0 px-3 pt-2">Movie App <span
                class="ms-3 text-white">{{ $category->name }}</span>
        </h5>
            ...
            <div class="row flex-nowrap overflow-hidden w-100 mx-auto">
                ...
                @foreach ($animes as $serie)
                    <div class="col-lg-5 custom-serie-w p-0 mx-2 position-relative" style="height: 400px">
                        ...
                        <div class="box-content position-absolute">
                            <p>مشاهده {{ $serie->getTranslation('name', 'en') }} ({{ $serie->production_year }})</p>
                ...
                @foreach ($movies as $movie)
                    <div class="col-lg-5 custom-serie-w p-0 mx-2 position-relative" style="height: 400px">
                        ...
                        <div class="box-content position-absolute">
                            <p>مشاهده {{ $movie->name }} ({{ $movie->production_year }})</p>
        ...
        <div class="movie-categories my-5">
            <ul class="d-flex p-3">
                <li style="background-color: #6375FF;"><a
                        href="{{ route('category.show', ['id' => $category->id]) }}">الافلام</a></li>
                <li><a href="{{ route('category.series.show', ['id' => $category->id]) }}">المسلسلات</a></li>
                <li><a href="{{ route('category.animes.show', ['id' => $category->id]) }}">انمى وكارتون</a></li>
                <li><a href="{{ route('category.tvs.show', ['id' => $category->id]) }}">العروض التليفيزيونية</a></li>
        ...
        <div class="row w-100 mx-auto justify-content-center">
            ...
            @foreach ($paginatedMovies as $item)
                <div class="col-lg-4 similar-movie-col   mx-2  movie-container d-flex flex-column">
                    ...
                    <div class="movie-caption d-flex flex-column">
                        <p>watch Film {{ $item->getTranslation('name', 'en') }} ({{ $item->production_year }})</p>
