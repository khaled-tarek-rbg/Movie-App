...
@section('content')
    <div class="col-lg-6 mx-auto center">
        ...
        <div class="movie-categories my-5">
            <ul class="d-flex p-3">
                <li style="background-color: #6375FF;"><a href="{{ route('client.series') }}">Last Eposides</a></li>
                <li><a href="{{ route('series.new') }}">New Series</a></li>
                <li><a href="{{ route('series.old') }}">Old Series</a></li>
                <li><a href="{{ route('series.best') }}">Best series</a></li>
                <li><a href="{{ route('series.top') }}">Top rated</a></li>
