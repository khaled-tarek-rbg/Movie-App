    ...
    <div class="col-lg-6 mx-auto center">
                ...
                @foreach ($eposides as $item)
                    <div class="col-lg-5 custom-serie-w p-0 mx-2 position-relative" style="height: 400px">
                        ...
                        <div class="box-content position-absolute">
                            <p>مشاهده مسلسل  {{ $item->serie->getTranslation('name', 'ar') == true ? $item->serie->getTranslation('name', 'ar') : $item->serie->getTranslation('name', 'en') }} موشم رقم
        ...
        <div class="movie-categories my-5">
            <ul class="d-flex p-3">
                ...
                <li style="background-color: #6375FF;"><a href="{{ route('series.old') }}">Old Series</a></li>
                <li><a href="{{ route('series.best') }}">افضل المسلسلات</a></li>
                <li><a href="{{ route('series.top') }}">الاعلى تقييما</a></li>
            ...
            @foreach ($old_series as $item)
                <div class="col-lg-4 similar-movie-col position-relative  mx-2  movie-container">
                    ...
                    <div class="movie-caption d-flex flex-column">
                        <p>مشاهده مسلسل
                            {{ $item->serie->getTranslation('name', 'ar') == true ? $item->serie->getTranslation('name', 'ar') : $item->serie->getTranslation('name', 'en') }}({{ $item->production_year }})
                        </p>
