...
@section('comment-form')
    <form action="{{ route('serie.comment') }}" method="POST">
...
@section('content')
    <div class="col-lg-6 mx-auto film-center" style="background-color: #0C0F21 ; padding-top: 70px;">
        <div class="row position-relative "
            ...
            <div class="content py-4 normal-w d-none">
                ...
                <ul class="unstyled d-flex  py-1 ">
                    ...
                    <li><a href="#"> مشاهده مسلسل
                            {{ $serie->getTraanslation('name', 'ar') == true ? $serie->getTraanslation('name', 'ar') : $serie->getTraanslation('name', 'en') }}
                            {{ $serie->production_year }} </a></li>
                </ul>


                <h4> <span class="ms-1">{{ $serie->name }} </span>
        ...
        <div class="row py-3  " style="background-color: #1A1D2E">
            <h3 class="mb-3">{{ $serie->name }} {{ $serie->production_year }}
            </h3>
