    ...
    <div class="col-lg-6 mx-auto center">
                ...
                @foreach ($anime_eposides as $item)
                    <div class="col-lg-5 custom-serie-w p-0 mx-2 position-relative" style="height: 400px">
                        ...
                        <div class="box-content position-absolute">
                            <p>مشاهده {{ $item->anime->getTranslation('name', 'en') }} موسم رقم
                                {{ $item->season->season_number }} حلقةرقم
        ...
        <div class="movie-categories my-5">
            <ul class="d-flex p-3">
                ...
                <li><a href="{{ route('client.animes.series') }}">مسلسلات انمى</a></li>
                <li style="background-color: #6375FF;"><a href="{{ route('client.animes.movies') }}">افلام انمى</a>
                </li>
