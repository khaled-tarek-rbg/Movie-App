...
@section('comment-form')
    <form action="{{ route('movie.comment') }}" method="POST">
        ...
        <input type="text" placeholder="write comment" class="ms-2 rounded border-0 " name="title">
    ...
    <div class="col-lg-6 mx-auto film-center show-center" style="background-color: #0C0F21 ; padding-top: 50px;">
        <div class="row position-relative "
            ...
            <div class="content py-4 normal-w d-none">
                ...
                <h4>{{ $movie->name }} ({{ $movie->production_year }})</h4>
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-lg-7 large-w-content">
                        <ul class="unstyled d-flex py-1">
                            ...
                            <li><a href="#"> مشاهده فيلم {{ $movie->name }} {{ $movie->production_year }} </a></li>
                        </ul>
                        ...
                        <div class="film-info py-2">
                            <ul class="m-0 p-0">
                                ...
                                <li><span>المدة</span>
                                    <p class="m-0"> {{ $movie->duration }} دقيقة</p>
                                </li>
                                <li><span>النوع</span>
                                    <p class="m-0">
            ...
            <div class="row py-3 " style="background-color: #262A42">
                ...
                <div class="col-xxl-6 col-xl-12 ">
                    ...
                    <div class="film-iframe">
                        ...
                        <iframe id="filmUrl" allowfullscreen src="{{ $movie->servers[0]->url }}" width="100%"
                            height="400"></iframe>
                ...
                <div class="col-xxl-3 col-xl-12">
                    <h3 style="text-align: right">سيرفرات التحميل</h3>


                    <div class="server-downloads d-flex flex-wrap justify-content-end">
        ...
        <div class="row  justify-content-center">
            ...
            @foreach ($similarMovies as $similarMovie)
                <div class="col-lg-4 mx-2 similar-movie-col movie-container d-flex flex-column justify-content-center"
                    ...
                    <a href="{{ route('movies.show', ['id' => $similarMovie->id]) }}" class="movie-img"
