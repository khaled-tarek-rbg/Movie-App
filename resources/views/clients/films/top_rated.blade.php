...
@section('content')
    <div class="col-lg-6 mx-auto center">
        ...
        <div class="movie-categories my-5">
            <ul class="d-flex p-3">
                <li><a href="{{ route('movies') }}">الافلام الجديدة</a></li>
                <li><a href="{{ route('movies.old') }}">الافلام القديمة</a></li>
                <li><a href="{{ route('movies.best') }}">افضل الافلام</a></li>
                <li style="background-color: #6375FF;"><a href="{{ route('movies.top') }}">الاكثر تقييما</a></li>
