...
@section('content')
    <div class="col-lg-6 mx-auto center">
        ...
        <div class="movie-categories my-5">
            <ul class="d-flex p-3">
                <li style="background-color: #6375FF;"><a href="{{ route('movies') }}">افلام جديده</a></li>
                <li><a href="{{ route('movies.old') }}">افلام قديمة</a></li>
                <li><a href="{{ route('movies.best') }}">اجمل الافلام</a></li>
                <li><a href="{{ route('movies.top') }}">الاعلى تقييما</a></li>
            ...
            @foreach ($paginatedMovies as $paginatedMovie)
                <div class="col-lg-4 similar-movie-col   mx-2  movie-container d-flex flex-column ">
                    ...
                    <a href="{{ route('movies.show', ['id' => $paginatedMovie->id]) }}" class="movie-img"
                        ...
                        <img src="{{ Storage::url($paginatedMovie->poster) }}" alt="" width="100%"
                            height="100%">
                    </a>
